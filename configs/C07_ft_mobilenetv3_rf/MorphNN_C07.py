"""C07 — Fine-tuned MobileNetV3 + 16 morph + RF.
MobileNetV3 was the top backbone in Phase 4 CV (0.874 vs MobileNetV2 0.865).
Tests if fine-tuning this stronger frozen backbone closes the gap further.
"""
import sys; sys.path.insert(0, str(__import__('pathlib').Path(__file__).resolve().parents[1]))
from shared_utils import *
from sklearn.ensemble import RandomForestClassifier

CFG      = "C07_ft_mobilenetv3_rf"
