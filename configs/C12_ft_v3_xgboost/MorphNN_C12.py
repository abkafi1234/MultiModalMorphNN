"""C12 — Fine-tuned MobileNetV3 + PCA-128 + XGBoost (GPU).
Best backbone (V3) + more PCA dims + strongest classifier.
XGBoost with GPU acceleration. This is the most powerful single-model config.
"""
import sys; sys.path.insert(0, str(__import__('pathlib').Path(__file__).resolve().parents[1]))
from shared_utils import *
import xgboost as xgb

CFG      = "C12_ft_v3_xgboost"
