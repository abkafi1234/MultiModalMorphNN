"""C16 — Fine-tuned MobileNetV3, 15 epochs + PCA-128 + RF.
C15 (10 ep): 0.9845, 13 errors. C11 (5 ep): 0.9819, 16 errors.
Trend: every +5 epochs reduces ~3 errors. Target: ≤10 errors → ≥0.9911.
Uses cosine warm restarts T_0=5, so restarts at epoch 5, 10, 15.
"""
...
print(f"\n{'='*55}\n{CFG}  |  16 morph + {N_PCA} FT ({BACKBONE}, {EPOCHS} ep) + RF\n{'='*55}")
