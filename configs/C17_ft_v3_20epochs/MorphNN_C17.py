"""C17 — Fine-tuned MobileNetV3, 20 epochs + PCA-128 + RF.
Pushing to 20 epochs. Two full warm-restart cycles (T_0=10).
Lower LR (5e-5) for careful fine-grained adaptation.
"""
...
print(f"\n{'='*55}\n{CFG}  |  16 morph + {N_PCA} FT ({BACKBONE}, {EPOCHS} ep, lr=5e-5) + RF\n{'='*55}")
