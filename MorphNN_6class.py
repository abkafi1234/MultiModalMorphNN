...
OUTPUT_DIR       = "./morphnn_results"
CACHE_DIR        = "./morphnn_cache"       # persisted feature arrays
...
def phase4_morphnn_hybrid(
    ...
    ax.set_title(f"MorphNN ({PRIMARY_BACKBONE} + RF) — 6-Class Holdout")
...
def main() -> None:
    ...
    print("=" * 65)
    print("MorphNN 6-Class Viral Exanthem Triage")
